                ...
                <tbody>
                    <?php foreach ($Galeri as $G) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url(); ?>berita/edit/<?= $G['id']; ?>" class="btn btn-primary btn-sm ml-5"><i class="fa fa-edit"></i>

                                </a>
                                <a href="<?php echo base_url(); ?>berita/hapus/<?= $G['id']; ?>" class="btn btn-danger btn-sm ml-5 tombol-hapus2"><i class="fa fa-trash"></i>
