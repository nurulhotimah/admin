                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                        Tenaga Pendidik</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">14 Guru</div>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                        Siswa/Siswi SMK PELNUS Serang</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">162 Siswa/i</div>
                                </div>
                                <div class="col-auto">
